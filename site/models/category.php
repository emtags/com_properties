...
/**
 * Properties Component Property Model
 *
 * @package     Realeza
 * @subpackage  com_properties
 * @since       1.0
 */
class PropertiesModelCategory extends JModelList
{
	/**
	 * Category items data
	 *
	...
	/**
	 * The list of other property categories.
	 *
	 * @access    protected
	 * @var        array
	 */
	...
	protected function getListQuery()
	{
		...
		$query->select($this->getState('list.select', 'a.*'))
			->from($db->quoteName('#__properties') . ' AS a')
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$user = JFactory::getUser();
		if ((!$user->authorise('core.edit.state', 'com_properties')) && (!$user->authorise('core.edit', 'com_properties')))
		{
	...
	public function getCategory()
	{
		if (!is_object($this->_item))
		{
			...
			$categories = JCategories::getInstance('Properties', $options);
