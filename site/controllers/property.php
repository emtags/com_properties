...
class PropertiesControllerProperty extends JControllerForm
{
	...
	public function go()
	{
		...
		$modelLink	= $this->getModel('Property', '', array('ignore_request' => true));
		...
		if (empty($link))
		{
			return JError::raiseWarning(404, JText::_('COM_PROPERTIES_ERROR_WEBLINK_NOT_FOUND'));
		}
		...
		$modelCat = $this->getModel('Category', 'PropertiesModel', array('ignore_request' => true));
		...
		{
			return JError::raiseWarning(404, JText::_('COM_PROPERTIES_ERROR_WEBLINK_URL_INVALID'));
		}
	}
}
