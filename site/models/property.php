...
/**
 * Properties Component Model for a Property record
 *
 * @package     Realeza
 * @subpackage  com_properties
 * @since       1.0
...
class PropertiesModelProperty extends JModelItem
{
	 ...
	 * @var		string
	 */
	protected $_context = 'com_properties.property';
	...
	/**
	 * Method to increment the hit counter for the property
	 *
	 * @param   integer  $id  Optional ID of the property.
	 *
	...
	public function hit($id = null)
	{
		...
		$property = $this->getTable('Property', 'PropertiesTable');
		return $property->hit($id);
	}
}
